# -*- coding: utf-8 -*-
"""
Created on Thu Jan 18 12:20:05 2024
...
# MobileNetSSD_deploy.prototxt is a text file which describes the architecture of the network, containing features such as input dimensions, layer types and hierarchy.
# MobileNetSSD_deploy.caffemodel, contains the weights of the model.

if len(sys.argv)==1:
    args={
    "prototxt":"F:\Cours PYTHON\Reconnaissance Objet\MobileNetSSD_deploy.prototxt.txt",
    "model":"F:\Cours PYTHON\Reconnaissance Objet\MobileNetSSD_deploy.caffemodel",
    "confidence":0.2,
    }
else:
    ...
    ap.add_argument("-p", "--prototxt", required=True,
        help="F:\Cours PYTHON\Reconnaissance Objet\MobileNetSSD_deploy.caffemodel")
...
if __name__ == '__main__':
    ...
    #frame= cv2.imread('F:\Cours PYTHON\Reconnaissance Objet\Baie_Ajaccio_voilier.jpg') # image
    #frame= cv2.imread('F:\Cours PYTHON\Reconnaissance Objet\Seville.jpg') # image
    #frame = cv2.imread('F:\Cours PYTHON\Reconnaissance Objet\BB Brazil.png') # image
    #frame = cv2.imread('F:\Cours PYTHON\Reconnaissance Objet\elephant_afrique.jpg')
    frame = cv2.imread('F:\Cours PYTHON\Chelsea.png')
   ...
   # while True:
    ...
    for i in np.arange(0, detections.shape[2]):
            ...
            if confidence > args["confidence"]:
                ...
                cv2.imwrite("F:\Cours PYTHON\Reconnaissance Objet\detection.png", frame)
